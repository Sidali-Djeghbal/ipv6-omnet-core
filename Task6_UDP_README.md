...
- RFC 768 — User Datagram Protocol: https://rfc-editor.org/rfc/rfc768
- RFC 3550 — RTP/Jitter calculation: https://rfc-editor.org/rfc/rfc3550
- INET Framework UdpBasicApp: https://inet.omnetpp.org/docs/users-guide/
